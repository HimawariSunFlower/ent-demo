...
func (pc *PetCreate) SetMasterID(id int) *PetCreate {
	pc.mutation.SetMasterID(id)
	return pc
}

// SetNillableMasterID sets the "master" edge to the User entity by ID if the given value is not nil.
func (pc *PetCreate) SetNillableMasterID(id *int) *PetCreate {
	if id != nil {
		pc = pc.SetMasterID(*id)
	}
	return pc
}

// SetMaster sets the "master" edge to the User entity.
func (pc *PetCreate) SetMaster(u *User) *PetCreate {
	return pc.SetMasterID(u.ID)
}
...
func (pc *PetCreate) createSpec() (*Pet, *sqlgraph.CreateSpec) {
	...
	if nodes := pc.mutation.MasterIDs(); len(nodes) > 0 {
